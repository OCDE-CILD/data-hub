(() => {
  ...
  const NAV_ITEMS = [
    ...
    { key: 'contact',                 label: 'Email Us',              href: 'mailto:redi@ocde.us', target: "_blank"},
    { key: 'work',                 label: 'Work With Us',              href: 'https://form.asana.com/?k=FPztxN3MWCxoKTl6R6Ey7A&d=32468375920771', target: "_blank"}
  ];
